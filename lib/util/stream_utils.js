 ...
 */
shaka.util.StreamUtils.videoElement = document.createElement('video');
...
shaka.util.StreamUtils.meetsRestrictions = function(
  ...
  let videoElement = shaka.util.StreamUtils.videoElement;

  let canPlay = videoElement.canPlayType(
    video.mimeType + ';codecs="' + video.codecs + '"'
  );
