 ...
 * @param {number} value The integer.
 * @param {boolean=} opt_isLittleEndian The integer.
 * @throws {shaka.util.Error} when writing past the end of the data view.
 * @export
 */
shaka.util.DataViewWriter.prototype.writeUint16 = function(value,
    opt_isLittleEndian) {
  var littleEndian = opt_isLittleEndian ?
      opt_isLittleEndian : this.littleEndian_;
  try {
    this.dataView_.setUint16(this.position_, value, littleEndian);
  } catch (exception) {
    this.throwOutOfBounds_();
  }
  this.position_ += 2;
...
shaka.util.DataViewWriter.prototype.writeUint32 = function(value,
  ...
  var littleEndian = opt_isLittleEndian ?
      opt_isLittleEndian : this.littleEndian_;
  try {
    this.dataView_.setUint32(this.position_, value, littleEndian);
  } catch (exception) {
    this.throwOutOfBounds_();
  }
  this.position_ += 4;
