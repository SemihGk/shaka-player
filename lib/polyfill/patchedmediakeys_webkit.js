    ...
    if (cfg.audioCapabilities) {
      for (var j = 0; j < cfg.audioCapabilities.length; ++j) {
        ...
        if (cap.contentType) {
          ...
          console.log(contentType, this.internalKeySystem_);
          if (tmpVideo.canPlayTypeWithKeySystem(contentType, this.internalKeySystem_)) {
...
shaka.polyfill.PatchedMediaKeysWebkit.MediaKeySystemAccess.prototype.
  ...
  shaka.log.debug(
      ...
      console.log(this.configuration_);
...
shaka.polyfill.PatchedMediaKeysWebkit.MediaKeys.prototype.onWebkitNeedKey_ =
  ...
  console.log(event);
  console.log(new TextDecoder("utf-8").decode(event.initData))
  var event2 =
...
shaka.polyfill.PatchedMediaKeysWebkit.MediaKeySession.prototype.generate_ =
  ...
  console.log(mangledInitData);
  console.log('mangledInitData', new TextDecoder("utf-8").decode(mangledInitData))
  try {
